<div class="container-fluid ">
    <div class="row text-center">
        <a class="blog-header-logo text-dark" href="#"><img src="src/XII.png" height="350px"></a>
    </div>
    <div class="row justify-content-between">
        <div class="col card rounded p-2 m-2 shadow">
            <div class="row ">
               <a href="index.php?page_id=4&cbt=pretest" style="text-decoration: none; color:black" ><h1><i class="fa fa-pencil" aria-hidden="true"></i> Pre-Test</h1></a>
            </div>
            <div class="row p-2">
               <p>เพื่อฝึกการวิเคราะห์ภาพเบื้องต้น โดยไม่บันทึกผล</p>
            </div>
